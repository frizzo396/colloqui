...
public interface CandidateTypeRepository extends JpaRepository<CandidateType, Long> {
	 ...
	 * @return the optional
	 */
	@Query("select new com.accenture.interview.rto.candidate.CandidateTypeRTO(c.id, c.description) from CandidateType c where upper(c.description)=upper(:description)")
